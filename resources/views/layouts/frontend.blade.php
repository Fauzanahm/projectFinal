  ...
  <body>
    ...
    <div class="humberger__menu__wrapper">
      ...
      <div class="humberger__menu__contact">
        <ul>
          <li><i class="fa fa-envelope"></i>dutami.ahafood@gmail.com </li>
          <li>Free Shipping for all Order of IDR100</li>
        </ul>
      </div>
    </div>
    <!-- Humberger End -->
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer__about">
              <div class="footer__about__logo">
                <a href="./index.html"><img src="{{ asset('frontend/img/logo1.png') }}" alt="" /></a>
              </div>
              <ul>
                <li>Address: Btn Puri Graha Permai, <br>Blok B-7 Macanang, Bar, Macanang, <br>Kec. Tanete Riattang Bar., <br>Kabupaten Bone, <br>Sulawesi Selatan 92711</li>
                <li>Phone: +62 813-5503-4520</li>
                <li>Email: dutami.ahafood@gmail.com</li>
              </ul>
            </div>
          </div>
